...
public class ConnectorConnectionPoolFactory extends ConnectionPoolFactory {
    ...
    private static final String INSTANCE_CONNECTION_NAME =
            "greennare:asia-northeast3:greennare-db";//System.getenv("INSTANCE_CONNECTION_NAME");
    private static final String INSTANCE_UNIX_SOCKET = "/cloudsql/greennare:asia-northeast3:greennare-db";//System.getenv("INSTANCE_UNIX_SOCKET");
    private static final String DB_USER = "cloudrun";//System.getenv("DB_USER");
    private static final String DB_PASS = "cloudrun";//System.getenv("DB_PASS");
    private static final String DB_NAME = "greennare";//System.getenv("DB_NAME");
